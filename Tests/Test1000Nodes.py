...
class Test1000Nodes(unittest.TestCase):
    g_algo = GraphAlgo()
    graph = g_algo.load_from_json('../data/1000NodesTest.json')
    ...
    def test_save(self):
        print("test_save")
        file = '../data/1000NodesTest.json'
        self.g_algo.load_from_json(file)
        self.g_algo.save_to_json(file + "_saved")
        file = '../data/1000NodesTest.json_saved'
        self.assertIsNotNone(file)


    def test_load(self):
        print("test_load")
        self.g_algo.load_from_json('../data/1000NodesTest.json_saved')
        self.assertIsNotNone(self.g_algo)

    def test_shortest_path(self):
        print("test_shortest_path")
        shortPath = self.g_algo.shortest_path(54,978)
        print(shortPath)
        #self.assertEqual(shortPath, (inf, []))

    def test_TSP(self):
        print("test_shortest_path")
        tsp = self.g_algo.TSP([22,759,333,960])
        print(tsp)
